<button class="btn btn-danger btn-xs" data-toggle="modal" data-target="#Delete<?php echo $jenis->id_jenis ?>">
...
<div class="modal-footer">
    ...
    <a href="<?php echo base_url('admin/jenis/delete/'.$jenis->id_jenis) ?>" class="btn btn-danger">
