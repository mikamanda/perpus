...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Hapus data link: <?php echo $link->nama_link ?></h4>
</div>
...
<div class="modal-footer">
    ...
    <a href="<?php echo base_url('admin/link/delete/'.$link->id_link) ?>" class="btn btn-danger">
