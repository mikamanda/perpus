<button class="btn btn-danger btn-xs" data-toggle="modal" data-target="#Delete<?php echo $usulan->id_usulan ?>">
...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Hapus data usulan: <?php echo $usulan->nama_pengusul ?></h4>
</div>
...
<div class="modal-footer">
    ...
    <a href="<?php echo base_url('admin/usulan/delete/'.$usulan->id_usulan) ?>" class="btn btn-danger">
